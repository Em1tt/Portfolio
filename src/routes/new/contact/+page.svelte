...
<div class="bg-gray-900">
    <main class="w-full grid place-items-center py-10 min-h-screen">
        <div class="grid grid-cols-1 drop-shadow-lg p-4 py-12 md:grid-cols-2 w-screen md:w-auto">
            <form on:submit|preventDefault={submit} class="bg-gradient-to-br from-cyan-500 to-blue-500 p-4 selection:bg-pink-500 rounded-tl rounded-tr md:rounded-tr-none md:rounded-bl md:p-14">
